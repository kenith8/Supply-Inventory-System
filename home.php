...
?>
				...
				<div id="filter">
					...
					?>
							<option value="controller.php?home&catID=<?php echo $_GET['catID']; ?>value=<?php echo $value;?>" select="selected"><?php echo $selectquery['subcatName']?></option>
						<?php
							while($row = mysqli_fetch_array($results)){
						?>
							<option value="controller.php?home&catID=<?php echo $_GET['catID']; ?>&value=<?php echo $row['subcatID'];?>"><?php echo $row['subcatName'];?></option>
					<?php 
							}
						}
						else{
					...
					<div id="search">
						<form class="form-inline" action="controller.php?home&catID=<?php echo $categoryid; ?>" method="post">
				...
				?>
						<script type='text/javascript'>
							window.onload = function(){
								...
								location = "controller.php?home&catID=<?php echo $categoryid; ?>";
							}
						</script>
				<?php
						}
		        ...
		        <div id="admin-function">
					...
					?>
							<script type='text/javascript'>
								window.onload = function(){
								alert("No DATA found");
								location = "controller.php?ahome&catID=<?php echo $categoryid; ?>";
								}
							</script>
					...
					?>
							...
							?>
									<tr id="datarow">
									    ...
									    <td><button class="form-control mb-2 mr-sm-2" style="background-color:#B3de81; border:none;border-radius:4px;" onclick="window.location.href = 'controller.php?home&catID=<?php echo $_GET['catID'];?>&get=<?php echo $row2['stockID'];?>';"><img src="images/icons/add.png" style="background-color:#B3de81;height:30px;width: 30px;"> Get</button></td>
								    </tr>
							<?php
								}
							?>
								...
								if(mysqli_num_rows($checkquery)>0){
									echo "<script type='text/javascript'>
										window.onload = function(){
											...
											location = 'controller.php?home&catID=$catID';}
										</script>";
								}
								else{
									if($checkidfetch['qty']<=0){
										...
										mysqli_query($connection,"INSERT INTO get_item (userID,stockID,itemID) VALUES ('$_SESSION[userID]','$getID','$checkidfetch[itemID]')");
										echo "<script type='text/javascript'>
											window.onload = function(){
							...
							?>
									<tr id="datarow">
							            ...
							            <td><?php echo $row2['risNO']; ?></td>
									   	<td><?php echo $date; ?></td>
									    <td><?php echo $row2['qty']; ?></td>
									    <td><button class="form-control mb-2" style="background-color:#B3de81; border:none;border-radius:4px;" onclick="window.location.href = 'controller.php?home&catID=<?php echo $_GET['catID'];?>&get=<?php echo $row2['stockID'];?>';"><img src="images/icons/add.png" style="background-color:#B3de81;height:30px;width: 30px;"> Get</button></td>
								    </tr>
							<?php
								}
							?>
...
?>
				...
				?>
							<option value="controller.php?home&value=<?php echo $value;?>" select="selected"><?php echo $selectquery['subcatName']?></option>
					<?php
						while($row = mysqli_fetch_array($results)){
					?>
							<option value="controller.php?home&value=<?php echo $row['subcatID'];?>"><?php echo $row['subcatName'];?></option>
				<?php 
						}
					}
					else{
				...
				?>
					...
					<div id="search">
						<form class="form-inline" action="controller.php?home" method="post">
							<input class="form-control mb-2 mr-sm-2" id="textfield" type="text" name="valueToSearch" placeholder="item ID and Item Name">
						...
						?>
								...
								?>
										<tr id="datarow">
									        ...
									        <td><?php echo $date; ?></td>
									        <td><?php echo $row2['qty']; ?></td>
									        <td><button class="form-control mb-2 mr-sm-2" style="background-color:#B3de81; border:none;border-radius:4px;" onclick="window.location.href = 'controller.php?home&get=<?php echo $row2['stockID'];?>';"><img src="images/icons/add.png" style="background-color:#B3de81;height:30px;width: 30px;"> Get</button></td>
								        </tr>
								<?php
									}
								?>
						...
						?>
								...
								?>
										<tr id="datarow">
									        ...
									        <td><?php echo $date; ?></td>
									        <td><?php echo $row2['qty']; ?></td>
									        <td><button class="form-control mb-2" style="background-color:#B3de81; border:none;border-radius:4px;" onclick="window.location.href = 'controller.php?home&get=<?php echo $row2['stockID'];?>';"><img src="images/icons/add.png" style="background-color:#B3de81;height:30px;width: 30px;"> Get</button></td>
								        </tr>
								<?php
									}
								?>
